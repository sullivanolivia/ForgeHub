...
#[derive(Debug)]
pub struct ForgeHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ForgeHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ForgeHub processing");
    
    let mut processor = ForgeHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ForgeHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ForgeHubProcessor::new(false);
